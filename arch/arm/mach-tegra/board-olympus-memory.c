...
static const struct tegra_emc_table olympus_emc_tables_samsung[] = {
	{
...
static const struct tegra_emc_table olympus_emc_tables_elpida_50nm[] = {
	{
		.rate = 25000,   /* SDRAM frequency */
		.regs = {
			0x00000002,   /* RC */
...
static const struct tegra_emc_table olympus_emc_tables_elpida_40nm[] = {
	{
		.rate = 25000,   /* SDRAM frequency */
		.regs = {
			0x00000002,   /* RC */
...
struct tegra_emc_chip olympus_emc_chips[] = {
	{
		...
		.mem_revision_id2 = -1,
		.mem_pid = 0x5454,
		.table = olympus_emc_tables_samsung,
		.table_size = ARRAY_SIZE(olympus_emc_tables_samsung)
	},
	{
		...
		.mem_revision_id2 = -1,
		.mem_pid = 0x5454,
		.table = olympus_emc_tables_elpida_40nm,
		.table_size = ARRAY_SIZE(olympus_emc_tables_elpida_40nm)
	},
	{
		...
		.mem_revision_id2 = -1,
		.mem_pid = 0x5454,
		.table = olympus_emc_tables_elpida_50nm,
		.table_size = ARRAY_SIZE(olympus_emc_tables_elpida_50nm)
	},
};
